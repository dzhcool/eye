...
// EyeInput operates the http request header, data, cookie and body.
...
// if non-existed, return empty string.
/*func (input *EyeInput) Session(key interface{}) interface{} {
...
func (input *EyeInput) bind(key string, typ reflect.Type) reflect.Value {
...
func (input *EyeInput) bindValue(val string, typ reflect.Type) reflect.Value {
	rv := reflect.Zero(reflect.TypeOf(0))
	switch typ.Kind() {
	case reflect.Int, reflect.Int8, reflect.Int16, reflect.Int32, reflect.Int64:
		rv = input.bindInt(val, typ)
...
func (input *EyeInput) bindInt(val string, typ reflect.Type) reflect.Value {
...
func (input *EyeInput) bindUint(val string, typ reflect.Type) reflect.Value {
...
func (input *EyeInput) bindFloat(val string, typ reflect.Type) reflect.Value {
...
func (input *EyeInput) bindString(val string, typ reflect.Type) reflect.Value {
	return reflect.ValueOf(val)
}

func (input *EyeInput) bindBool(val string, typ reflect.Type) reflect.Value {
...
func (input *EyeInput) bindSlice(params *url.Values, key string, typ reflect.Type) reflect.Value {
	maxIndex := -1
	numNoIndex := 0
...
func (input *EyeInput) bindStruct(params *url.Values, key string, typ reflect.Type) reflect.Value {
...
func (input *EyeInput) bindPoint(key string, typ reflect.Type) reflect.Value {
	return input.bind(key, typ.Elem()).Addr()
}

func (input *EyeInput) bindMap(params *url.Values, key string, typ reflect.Type) reflect.Value {
	var (
